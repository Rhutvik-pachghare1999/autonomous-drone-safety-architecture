...
| Claim | Source location | Evidence | Status |
|---|---|---|---|
| 1,000 adversarial trials, 100% survival | `experiments/exp_adversarial_1000.py`, `experiments/results/hallucination_1000.json` | `python3 experiments/exp_adversarial_1000.py` → survival 100% | verified |
| Worst corrected command: T_nom = −380.4 N, T_safe = 16.9 N, correction 397.25 N | `experiments/results/hallucination_1000.json` | Re-running `exp_adversarial_1000.py` reproduces `max_correction_N = 397.2496` | verified |
