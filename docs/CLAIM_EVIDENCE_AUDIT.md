...
| Worst corrected command: T_nom = −380.4 N, T_safe = 16.9 N, correction 397.25 N | `experiments/results/hallucination_1000.json` | Re-run prints the same correction; previous README value "78.5 N" was stale | verified |
...
| P6: NaN/Inf rejected before FSM | `src/control/hocbf.cpp`, `src/rt/safety_filter.c`, `tests/test_input_validation.py` | 17 pytest cases pass | verified |
